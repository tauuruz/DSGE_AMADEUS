...
import VIEW.interfazDowngrade;
import VIEW.interfazLibreria;
import VIEW.interfazUpgrade;

import javax.swing.JTextField;
import javax.swing.JPasswordField;

public class interfazCuentaDev {
	...
	public static void main(String[] args,desarrollador desarrollador) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					interfazCuentaDev window = new interfazCuentaDev(desarrollador);
	 ...
	 */
	public interfazCuentaDev(desarrollador desarrollador) {
	...
	private void initialize(desarrollador desarrollador) {
		...
		cuentaIU = new JFrame();
		cuentaIU.setTitle("Mi cuenta - " + desarrollador.getDev());
		cuentaIU.setIconImage(Toolkit.getDefaultToolkit().getImage(interfazCuentaDev.class.getResource("/img/icono.png")));
		...
		usuariotxt.setText(desarrollador.getDev());
		...
		nombretxt.setText(desarrollador.getNombre());
